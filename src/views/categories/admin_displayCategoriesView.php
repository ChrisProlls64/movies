...
<div class="row row-cols-1 row-cols-md-2">
  <ul class="list-group list-group-flush col mx-auto mb-3">
    <?php
    ...
    foreach ($categories as $category) { ?>
      <li class="list-group-item">
        ...
        <?= $category['name'] ?>
        <a class="link-warning ms-3" href="<?= $router->generate('deleteCategory', ['id' =>  htmlentities($category['id'])]); ?>" onclick="return confirm('êtes-vous sûr de vouloir supprimer cette catégorie ?')">
